...
export default function FiguresGrid({
  ...
  // NEW: series + character + variant filters
                      ...
                      return (
                        <div key={key} className="mt-2 border border-[var(--border)] rounded-lg p-2">
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            <button className={`badge ${allSelected ? "" : "opacity-60"}`} onClick={() => {
          ...
          <div className="ml-auto flex flex-wrap items-center gap-2">
            <div className="rounded-lg border border-[var(--border)] p-1">
              {(["all", "owned", "wishlist"] as const).map((t) => (
                <button key={t} className={`px-3 py-2 rounded-md text-sm ${tab === t ? "bg-gray-100" : "hover:bg-gray-50"}`}
                        onClick={() => setTab(t)}>
